...
// JFRandom.m
//
// Created by Development on 10/04/26.
...
/*
 * Chooses a number from the provided sequence and places it into the receiver.
 *
 * Params
 *		sequence	The receiving sequence.
...
+ (NSString *) generateRandomStringOfLength: (NSUInteger) length {
	...
	JFFree(sequence);
	NSString *string = [NSString stringWithCString: randData encoding: NSASCIIStringEncoding];
	JFFree(randData);
